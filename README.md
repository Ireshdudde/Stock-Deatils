...
<head>
  <meta charset="UTF-8">
  <title>Savda Stock Details (31/07/2025)</title>
  <style>
    body {
    ...
    .card.inward { border-left-color: #00b894; }
    .card.outward { border-left-color: #fd9644; }
    .card.balance { border-left-color: #6c5ce7; }
